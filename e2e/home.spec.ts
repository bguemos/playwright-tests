...
import { PAGES_MANIFEST, PHASE_EXPORT } from 'next/dist/shared/lib/constants';
...
test.describe('Button tests', () => {
    test.skip('This is the info component', async ({ page })  => {
     await page.goto(homePage);
     await expect(page.locator('button')).toContainText("View all of this info")
    })
})
...
test.describe('Check About page naviagtes to the home page tests', () => {
